...
# 
# Description   : ADQ14 pin mapping constraints, MTCA specific
# Documentation :
# 
# 
...
# Note: HSWAPSW_FPGA# in schematics
...
# Note: RX 4-7 are now used for point-to-point RX 0-3
...
# Note: TX 4-7 are now used for point-to-point TX 0-3
...
# Note: Still present in MTCA schematic, resistor to GND
set_property PACKAGE_PIN AH21 [get_ports pxie_perst]

# Note: STARA/STARB is left unconnected on the MTCA boards. This allows us to keep the whole LVDS/IDELAY/ISERDES block, avoiding
#       a huge amount of ifdef-ing in firmware.
...
# New signals for MTCA:

set_property PACKAGE_PIN AK25 [get_ports {mlvds_rx_i[0]}]
set_property PACKAGE_PIN AF20 [get_ports {mlvds_rx_i[1]}]
set_property PACKAGE_PIN AH22 [get_ports {mlvds_rx_i[2]}]
set_property PACKAGE_PIN AG20 [get_ports {mlvds_rx_i[3]}]

set_property PACKAGE_PIN AH25 [get_ports {mlvds_tx_i[0]}]
set_property PACKAGE_PIN AK21 [get_ports {mlvds_tx_i[1]}]
set_property PACKAGE_PIN AJ22 [get_ports {mlvds_tx_i[2]}]
set_property PACKAGE_PIN AJ23 [get_ports {mlvds_tx_i[3]}]

set_property PACKAGE_PIN AD21 [get_ports {mlvds_rx_o[0]}]
set_property PACKAGE_PIN AE23 [get_ports {mlvds_rx_o[1]}]
set_property PACKAGE_PIN AG23 [get_ports {mlvds_rx_o[2]}]
set_property PACKAGE_PIN AH24 [get_ports {mlvds_rx_o[3]}]

set_property PACKAGE_PIN AE21 [get_ports {mlvds_tx_o[0]}]
set_property PACKAGE_PIN AF23 [get_ports {mlvds_tx_o[1]}]
set_property PACKAGE_PIN AG24 [get_ports {mlvds_tx_o[2]}]
set_property PACKAGE_PIN AJ24 [get_ports {mlvds_tx_o[3]}]

set_property PACKAGE_PIN C22 [get_ports pp_10m_en]

set_property PACKAGE_PIN A21 [get_ports pp_pll_cs_n]

set_property PACKAGE_PIN L15 [get_ports mmc_rst]

set_property PACKAGE_PIN L12 [get_ports mmc_progen_n]
set_property PACKAGE_PIN K13 [get_ports mmc_uart_i]
set_property PACKAGE_PIN G13 [get_ports mmc_uart_o]
set_property PACKAGE_PIN J12 [get_ports mmc_sck]

set_property PACKAGE_PIN J13 [get_ports mmc_sdat]
set_property PACKAGE_PIN J14 [get_ports mmc_sclk]

set_property PACKAGE_PIN T5 [get_ports {pp_rx_n[0]}]
set_property PACKAGE_PIN T6 [get_ports {pp_rx_p[0]}]
set_property PACKAGE_PIN R3 [get_ports {pp_rx_n[1]}]
set_property PACKAGE_PIN R4 [get_ports {pp_rx_p[1]}]
set_property PACKAGE_PIN P5 [get_ports {pp_rx_n[2]}]
set_property PACKAGE_PIN P6 [get_ports {pp_rx_p[2]}]
set_property PACKAGE_PIN M5 [get_ports {pp_rx_n[3]}]
set_property PACKAGE_PIN M6 [get_ports {pp_rx_p[3]}]

set_property PACKAGE_PIN P1 [get_ports {pp_tx_n[0]}]
set_property PACKAGE_PIN P2 [get_ports {pp_tx_p[0]}]
set_property PACKAGE_PIN N3 [get_ports {pp_tx_n[1]}]
set_property PACKAGE_PIN N4 [get_ports {pp_tx_p[1]}]
set_property PACKAGE_PIN M1 [get_ports {pp_tx_n[2]}]
set_property PACKAGE_PIN M2 [get_ports {pp_tx_p[2]}]
set_property PACKAGE_PIN L3 [get_ports {pp_tx_n[3]}]
set_property PACKAGE_PIN L4 [get_ports {pp_tx_p[3]}]
